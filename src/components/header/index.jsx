...
const Header = ({ t, value, handleChange, languages }) => {
          ...
          <div className="col-12">
            <div className="header__body d-flex justify-content-between">
                ...
                <div className="left__main">
                  ...
                  >
                    <ul id="menu-primary-menu" className="menu">
                      ...
                      <Dropdown>
                        {/* <Dropdown.Toggle class="header_bright">
                          EN/KOR
                        </Dropdown.Toggle> */}
              ...
              <div className="header__right">
                {/* <Dropdown>
                  <Dropdown.Toggle>{t("Assets")}</Dropdown.Toggle>

                  <Dropdown.Menu>
                    <Dropdown.Item href="#">
                      <li data-toggle="modal" data-target="#delete_client">
                        {t("Binance Visa Card")}
                      </li>
                    </Dropdown.Item>
                    <Dropdown.Item href="#">
                      <li data-toggle="modal" data-target="#edit_client">
                        {t("Crypto Loans")}
                      </li>
                    </Dropdown.Item>
                    <Dropdown.Item href="#">
                ...
                {/* <Dropdown>
                  <Dropdown.Toggle>{t("Orders & Trades")}</Dropdown.Toggle>
                    ...
                    {languages.map((item) => (
                      <Dropdown.Item href="#" onClick={handleChange}>
                        <Link
                          ...
                          data-lang="en"
                        >
                          <span className="align-middle"> {t(item.text)}</span>
                        </Link>
                      </Dropdown.Item>
                    ))}
                  </Dropdown.Menu>
