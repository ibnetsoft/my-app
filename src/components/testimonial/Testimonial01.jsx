...
function Testimonial01(props) {
  ...
  const [dataBlock] = useState({
    ...
    desc: "Transform Your idea into Reality With OTCmarket",
    text: "",
  });
        ...
        <div className="row">
          <div className="col-xl-6 col-md-12">
            <div className="block-text">
              <h3 className="heading">{t(dataBlock.title)}</h3>
              <h6 className="fs-20">{t(dataBlock.desc)}</h6>
              <p>{t(dataBlock.text)}</p>
              ...
              <div className="couter">
                <h6>30+</h6>
                <p className="title">OTC market member</p>
              </div>
            </div>
          </div>
          <div className="col-xl-6 col-md-12">
              ...
              {data.map((idx) => (
                <SwiperSlide key={idx.id}>
                  <div className="testimonials-box">
                    ...
                    <h6 className="text">{t(idx.text)}</h6>
