            ...
            <div className="col-xl-4 col-md-12">
              <div className="sidebar">
                ...
                <div className="widget category">
                  ...
                  <ul>
                    <li>
                      <Link to="/blog-grid-v1">Blockchain</Link>
                    </li>
                    <li>
                      <Link to="/blog-grid-v1">Technology</Link>
                    </li>
                    <li>
                      <Link to="/blog-grid-v1">Community</Link>
                    </li>
                    <li>
                      <Link to="/blog-grid-v1">Learn & Earn</Link>
                    </li>
                  </ul>
                </div>
                  ...
                  <div key={idx.id} className="blog-box">
                    ...
                    <div className="box-content">
                      ...
                      <p className="text">
                        ...
                        Consectetur nibh curabitur sit in adipiscing purus ut
                        sem. Donec nulla sem rhoncus dolor aliquam.
                      </p>
